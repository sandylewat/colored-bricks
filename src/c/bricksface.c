...
typedef struct {
    int8_t bg_color;    /* 0 = random, 1-8 = solid LEGO colour index        */
...
/* Background brick colour: solid or position-based random pattern. */
static GColor bg_brick_color(int col, int row) {
    if (s_settings.bg_color == 0) {
        return lego_color((col * 5) + (row * 7));   /* varied pattern */
    }
    return lego_color(s_settings.bg_color - 1);     /* solid colour   */
}
    ...
    for (int d = 0; d < 4; d++) {
        ...
        for (int row = 0; row < 5; row++) {
            ...
            for (int col = 0; col < 3; col++) {
                ...
                GColor color = on ? on_color : GColorDarkGray;
